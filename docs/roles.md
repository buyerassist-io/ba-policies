...
The Chief Security Officer (CSO) is responsible for working with user management, owners, custodians, and users to develop and implement prudent security policies, procedures, and controls, subject to the approval of BuyerAssist. In HIPAA terms, the CSO is considered the "Security Officer" for BuyerAssist. Specific responsibilities include:
...
* Reporting regularly to the Information Security and Risk Management Committee on BuyerAssist’s status with regard to risk and information security.

### Data/Application Owner

The owner of a collection of information is usually the manager responsible for the creation of that information or the primary user of that information. This role often corresponds with the management of an organizational unit. In this context, ownership does not signify proprietary interest, and ownership may be shared. The owner may delegate ownership responsibilities to another employee. It should be noted that BuyerAssist takes every effort to ensure that customer data is stored only in customer-owned and maintained environments. At no time does BuyerAssist have intentional access to customer production data. The owner of information has the responsibility for:
...
* Reporting promptly to the CSO or delegate the loss or misuse of BuyerAssist (or customer) information.
...
* Reporting promptly to the CSO or delegate the loss or misuse of BuyerAssist information.
* Identifying and responding to security incidents and initiating appropriate actions when problems are identified.

### Manager

Managers are BuyerAssist employees who supervise other employees in the capacities described below.  User management is responsible for overseeing their employees' use of information, including:
...
* Follow proper procedure for  all disclosures of PHI outside of BuyerAssist and within BuyerAssist, other than for treatment, payment, or health care operations.
...
* Report promptly to the CSO or delegate the loss or misuse of BuyerAssist. information.
...
The Privacy Officer, in collaboration with the CSO or delegate, Information Security/Risk Management/Compliance Team, and senior leadership, are responsible for overseeing the development, implementation, and oversight of all activities pertaining to BuyerAssist’s efforts to be compliant with, among other compliance mandates, the HIPAA Privacy Rule (Privacy Rule) and Breach of Unsecured PHI Rule, as applicable and as described in Business Associate Agreements. The intent of all oversight activities include those necessary to maintain the Confidentiality, integrity, and availability of protected information as described in the Information and System Classification section of this policy. These responsibilities include, but are not limited to the following:
...
* Serve as a resource for BuyerAssist staff and customers regarding the privacy of protected and confidential information and data.
...
* Make all reasonable efforts to limit incidental uses and disclosures and protect the privacy of PHI from intentional or unintentional uses and disclosures that are in violation of the law or BuyerAssist’s policies and procedures.
...
* Ensure prompt, proper, and consistent investigations as well as consistent and appropriate sanctions are provided against workforce members who fail to comply with BuyerAssist’s privacy policies and procedures; takes appropriate steps to prevent recurrence.
...
* Monitor, audit, and reinforce compliance with the law and BuyerAssist’s privacy policies and procedures.
...
* Responsible for notification to customers regarding change plans, maintenance, or other issues that may affect production cloud environment. This may be delegated to another BuyerAssist Customer Support role dependent on scenario.
* Provide updates to Customer Support Manager regarding customer environment status
* Coach and provide guidance for customers migrating to BuyerAssist hosted environment
...
* Manage membership and maintain documentation regarding BuyerAssist security groups
...
* Support remote access to BuyerAssist cloud environments
...
* Install, configure, document and maintain BuyerAssist Platforms and Technologies
...
Responsible for installing and administering servers (where needed), databases, and applications hosted in the BuyerAssist production hosting environment
* Responsible for notifying BuyerAssist of any performance or availability issues affecting their environment
* Send support tickets and requests to BuyerAssist through Customer Ticketing Tool
